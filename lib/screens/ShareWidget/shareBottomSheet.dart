...
class ShareBottomSheet {
  ...
  void settingModalBottomSheet(context, String doctorUid,String doctorFirstName,String userId) {
            ...
            child: new Wrap(
              ...
              setData.then(
                (data)=>{
                   ...
                   data.setString("doctor name",doctorFirstName),
                }
              );
                            _transaction =   UpiTranstionService( doctorUserID: doctorUid,patientUid: userId,doctorName: doctorFirstName).initiateTransaction();
                            }),
                      ],
                    ),
                    SizedBox(height: 20),
              ...
              setData.then(
                (data)=>{
                  ...
                  this.doctorName = data.getString("doctor name"),
                  print(patientNum+"  "+patientName),
                    ...
                    DataBaseServices().transactionOfAppotiment(doctorUid,doctorName, userId ,patientName,patientNum, txnId, resCode, txnRef, status, approvalRef)
                }
              ); 
