...
class Catgagery extends StatefulWidget {
  ...
  Catgagery({this.userid, this.userName});

  @override
  _CatgageryState createState() =>
      _CatgageryState(userid: this.userid, userName: this.userName);
}
...
class _CatgageryState extends State<Catgagery> {
  ...
  _CatgageryState({this.userid, this.userName});
