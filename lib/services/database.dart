...
class DataBaseServices{
  ...
  final CollectionReference doctorsRference = Firestore.instance.collection("Users");
  final CollectionReference appointementRefrence = Firestore.instance.collection("Appotiments");
 ...
 _brewListFormQuesrySanpshot(QuerySnapshot snapshot) {
  ...
  Future registerUser(String uId,String firstName, String lastName, int age,String gender,String city) async {
  ...
  Future transactionOfAppotiment(String getDoctorUid,String getDoctorName,String patientUid,String getpatientName,String getpatientNum,String txnId, String resCode, String txnRef,String status,String approvalRef) async {
    ...
    Future appotiment(String testing,String getDoctorUid,String getdoctorName,String patientUid,String getpatientName,String getpatientNum) async {
    return await appointementRefrence.add({
  "Testing":testing,
