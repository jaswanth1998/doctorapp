...
//     assert(user.uid == currentUser.uid);
  ...
  print("verificationid");
      ...
      AuthCredential  credential1 =   PhoneAuthProvider.getCredential(verificationId: this.verificationId, smsCode:code );
    print("i am auth");
    print(credential1);
    try{

    
     final FirebaseUser user =  (await _auth.signInWithCredential(credential1)).user;
     print(user.uid + "Uid");
    }catch(e){
      print(e);
    }
